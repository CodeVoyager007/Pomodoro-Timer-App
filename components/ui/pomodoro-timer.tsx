...
export default function PomodoroComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#D4F1F4]">
      {/* Center the Pomodoro timer card within the screen */}
      <Card className="w-full max-w-md p-6 bg-white shadow-lg rounded-lg">
        <div className="flex flex-col items-center justify-center gap-6">
          <h1 className="text-4xl font-bold text-[#05445E]">Pomodoro Timer</h1>
          <p className="text-[#189AB4]">A timer for the Pomodoro Technique.</p>
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-8xl font-bold text-[#75E6DA]">
...
`}{" "}
      ...
      {/* Tagline at the bottom right corner */}
      <div className="fixed bottom-4 right-4 text-lg font-bold text-[#05445E]">
